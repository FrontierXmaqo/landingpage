...
const ATAP_COLUMNS = ["Contact", "State", "Postcode", "Source", "Status", "Received", "Notes"];
const CI_COLUMNS = ["Contact", "Company / Industry", "State", "Postcode", "Bill range", "Status", "Received", "Notes"];
