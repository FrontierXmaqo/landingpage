...
import SiteMenu, { type SiteMenuItem } from "./SiteMenu";
    ...
    <header className="sticky top-0 z-40 w-full border-b border-base-line bg-base-panel/90 backdrop-blur">
      <div className="mx-auto flex max-w-6xl items-center justify-between gap-3 px-4 py-3 sm:px-6">
        ...
        <div className="flex items-center gap-2 sm:gap-4">
          ...
          <SiteMenu label={t.header.menu} items={siteMenuItems(locale, t)} />
        </div>
      </div>
    </header>
  );
...
/** The menu's rows — shared with the EV page, which has its own header. */
export function siteMenuItems(locale: Locale, t: Dictionary): SiteMenuItem[] {
