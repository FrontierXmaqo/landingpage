...
export default function BessFlowDiagram({ t }: { t: Dictionary["bess"]["heroVisual"] }) {
  ...
  return (
    <div className="rounded-[20px] border border-base-line bg-[var(--paper,#FBF8F3)] shadow-xl">
      <style>{`
        .bess-flow-canvas {
